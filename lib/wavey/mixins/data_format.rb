    ...
    protected
      ...
      def waves_from_wavelets(wavelets)
        ...
        wave_wavelet_map.collect do |wave_id, wavelet_ids|
          Wavey::Models::Wave.new(:id => wave_id, :wavelet_ids => wavelet_ids)
        end
      end
